...
export const Testimonials = (testimonials: any) => {
  const Testi = [
    {
      image:
        testimonials?.testimonials?.cac_danh_gia[0]?.anh_hoc_vien ||
        "/testimo.webp",
      name:
        testimonials?.testimonials?.cac_danh_gia[0]?.ten_hoc_vien ||
        ".Nguyễn Thị Ngọc Lan",
      career:
        testimonials?.testimonials?.cac_danh_gia[0]?.nghe_nghiep ||
        `.Chuyên Viên Phân tích và Nghiên cứu Cấp cao`,
      comment:
        testimonials?.testimonials?.cac_danh_gia[0]?.danh_gia ||
    ...
    {
      image:
        testimonials?.testimonials?.cac_danh_gia[1]?.anh_hoc_vien ||
        "/testimo2.webp",
      name:
        testimonials?.testimonials?.cac_danh_gia[1]?.ten_hoc_vien ||
        ".Phạm Văn Phong",
      career:
        testimonials?.testimonials?.cac_danh_gia[1]?.nghe_nghiep ||
        `.Nhân viên văn phòng`,
      comment:
        testimonials?.testimonials?.cac_danh_gia[1]?.danh_gia ||
    ...
    {
      image:
        testimonials?.testimonials?.cac_danh_gia[2]?.anh_hoc_vien ||
        "/testimo3.webp",
      name:
        testimonials?.testimonials?.cac_danh_gia[2]?.ten_hoc_vien ||
        ".Đậu Thị Phương Thảo",
      career:
        testimonials?.testimonials?.cac_danh_gia[2]?.nghe_nghiep ||
        `.Nhân viên văn phòng`,
      comment:
        testimonials?.testimonials?.cac_danh_gia[2]?.danh_gia ||
