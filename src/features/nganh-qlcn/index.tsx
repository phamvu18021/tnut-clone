  ...
  return (
    ...
    >
      <MajorsDetails
        ...
        tabsp={[
          "Ngành Quản Lý Công Nghiệp được đánh giá là một ngành học có nhiều triển vọng nghề nghiệp trong tương lai với cơ hội việc làm rộng mở và mức lương hấp dẫn.",
          "Cử nhân ngành Quản Lý Công Nghiệp sau khi ra trường sẽ có cơ hội làm việc tại các tổ chức sản xuất, dịch vụ, thương mại với các quy mô khác nhau, đặt biệt có nhiều cơ hội làm việc tại các công ty đa quốc gia với các vị trí làm việc sau khi tốt nghiệp như: ",
          ". Quản lý nhà máy",
          ". Quản lý mua hàng",
          ". Quản lý sản xuất",
